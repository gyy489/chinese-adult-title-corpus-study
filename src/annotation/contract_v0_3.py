...
from src.annotation import contract_v0_2 as v02

ROOT = Path(__file__).resolve().parents[2]
DEFAULT_CODEBOOK = ROOT / "config/annotation_codebook_v0_3.json"
DEFAULT_SCHEMA = ROOT / "config/annotation_output_schema_v0_3.json"
DEFAULT_PROMPT = ROOT / "prompts/annotation_prompt_v0_3.md"
